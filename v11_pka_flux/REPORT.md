...
**Setup.**
- Bioact table: 336 rows with `log10_flux_total` and `predicted_pKa`.
- Predicted pKa: v9.1 LOO on 330 rows present in v21 (pooled MAE on those = 0.0598, expected ≈0.067), v9.1 full-bundle on 31 remaining rows.
...
|---|---|---|---|---|---|
| M0 | 0.679 | 0.950 | -0.397 | 0.201 | 336 |
| M0_quad | 0.630 | 0.816 | -0.032 | -0.012 | 336 |
| M1 | 0.586 | 0.851 | -0.122 | 0.340 | 336 |
| M2 | 0.497 | 0.724 | 0.188 | 0.490 | 336 |
| M3 | 0.430 | 0.629 | 0.389 | 0.594 | 335 |

## Per-family MAE
| Family | n | M0-MAE | M1-MAE | M2-MAE | M3-MAE |
|---|---|---|---|---|---|
| Dialkoxybenzyl | 18 | 0.401 | 0.206 | 0.173 | 0.154 |
| G1-Janus-Dendrimer | 27 | 0.732 | 0.837 | 0.657 | 0.659 |
| GA-Tris | 50 | 0.669 | 0.593 | 0.570 | 0.620 |
| HTM-Dendrimer | 10 | 0.580 | 0.301 | 0.436 | 0.413 |
| PE-Tris | 51 | 1.116 | 1.130 | 0.695 | 0.376 |
| TT-Dendrimer | 5 | 1.109 | 0.516 | 0.583 | 0.898 |
| sSS-Nonsym | 175 | 0.568 | 0.444 | 0.429 | 0.374 |

## Family pKa optima (inverted-U fits on held-out predictions)
| Family | n | pKa_opt | curvature b | rmse | note |
|---|---|---|---|---|---|
| Dialkoxybenzyl | 18 | 12.000 | 0.031 | 0.224 | optimum_at_boundary_no_clear_peak |
| G1-Janus-Dendrimer | 27 | 12.000 | 0.136 | 0.813 | optimum_at_boundary_no_clear_peak |
| GA-Tris | 50 | 6.048 | 3.241 | 0.652 | — |
| HTM-Dendrimer | 10 | 3.000 | 0.218 | 0.636 | optimum_at_boundary_no_clear_peak |
| PE-Tris | 51 | 5.547 | 2.206 | 1.145 | — |
| TT-Dendrimer | 5 | — | — | — | too_few_rows |
| sSS-Nonsym | 175 | 3.000 | 0.064 | 0.571 | optimum_at_boundary_no_clear_peak |

## SHAP top features for M2 (mean |SHAP value|, full-table refit)
| Rank | Feature | mean |SHAP\| |
|---|---|---|
| 1 | `MolLogP` | 0.1430 |
| 2 | `predicted_pKa` | 0.1364 |
| 3 | `TPSA` | 0.1103 |
| 4 | `RotatableBonds` | 0.1101 |
| 5 | `pKa_x_fam_sSS-Nonsym` | 0.0783 |
| 6 | `fam_PE-Tris` | 0.0779 |
| 7 | `FractionCSP3` | 0.0544 |
| 8 | `pKa_x_fam_PE-Tris` | 0.0479 |
| 9 | `LabuteASA` | 0.0429 |
| 10 | `NumAromaticRings` | 0.0375 |
...
- M3 baseline was refit per fold using the v14 bundle's stored `X_train/y_train/fps_train`. 1 bioact rows have a canonical SMILES that does not match any v14 training row and were skipped in the M3 column (M3 n=335 vs n=336). They remain in M0/M1/M2 columns.
...
## Verdict
**pKa-dominant model is a useful baseline but underperforms v1.1 by 0.067 log units** (M2 MAE=0.497, M3 MAE=0.430).
